...
#' @param lang Language for the labels in the resulting plots.
#' @param title Can either be \code{"none"}, \code{"short"} or \code{"long"}. For the respective `var`, it gives information about the number of levels and their respective frequency in the data.
